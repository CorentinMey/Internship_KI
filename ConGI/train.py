...
def train(args, name):
    ...
    # dataset
    trainset = Dataset(dataset, path, pathI, name, gene_preprocess=gene_preprocess, n_genes=n_gene,
    ...
    testset = Dataset(dataset, path, pathI, name, gene_preprocess=gene_preprocess, n_genes=n_gene,
                       prob_mask=prob_mask, pct_mask=pct_mask, prob_noise=prob_noise, pct_noise=pct_noise, sigma_noise=sigma_noise,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pathI', type=str, defaut="None")
